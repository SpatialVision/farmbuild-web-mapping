...
angular.module("farmbuild.farmdata").factory("farmdata", function($log, farmdataSession, farmdataValidator, farmdataPaddockGroups, farmdataPaddockTypes, farmdataPaddocks, crsSupported, validations) {
    var farmdata = {
